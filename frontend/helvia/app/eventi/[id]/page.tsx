...
import { ArrowLeft, Calendar, MapPin, Clock, Euro, Sparkles, Users, Share2, CheckCircle2 } from 'lucide-react'
...
export default function EventDetailPage() {
  ...
  const handleParticipate = () => {
    if (!canShare) {
      alert('Per partecipare agli eventi, devi abilitare "Condividi Attività" nelle Preferenze.')
      return
    }
      ...
      <div className="max-w-4xl mx-auto px-6 -mt-8 relative z-10 space-y-8 pb-8">
        <div className="glass-effect rounded-3xl p-8 shadow-2xl border-2 border-primary/20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
            <div className="flex items-center gap-4 p-4 bg-background rounded-2xl border border-border/50">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-foreground">15 Marzo 2025</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-background rounded-2xl border border-border/50">
              ...
              <div>
                <p className="text-xs text-muted-foreground font-medium">Orario</p>
                <p className="text-sm font-semibold text-foreground">20:30 - 22:30</p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4 p-4 bg-background rounded-2xl border border-border/50">
              ...
              <div>
                ...
                <p className="text-sm font-semibold text-foreground">Teatro Lauro Rossi</p>
              </div>
            </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl border border-primary/20">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-foreground">127 persone partecipano</p>
        ...
        <div className="glass-effect rounded-3xl p-8 shadow-xl border-2 border-border/50">
          ...
          <p className="text-foreground/90 leading-relaxed text-base">
            Un concerto straordinario che celebra la musica classica italiana nel
            magnifico Teatro Lauro Rossi. L'Orchestra Sinfonica di Macerata
            eseguirà le opere più amate di Rossini, Verdi e Puccini. Un'esperienza
            culturale unica nel cuore della città, perfetta per gli amanti della
            musica classica e per chi vuole scoprire il patrimonio musicale
            italiano.
          </p>
          
          <div className="mt-6 pt-6 border-t border-border/50">
            <h3 className="text-lg font-semibold text-foreground mb-3">Cosa aspettarsi</h3>
        ...
        <div className="glass-effect rounded-3xl p-8 shadow-xl border-2 border-secondary/30 bg-gradient-to-br from-secondary/5 to-accent/5">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Raccomandazione personalizzata per te</p>
            </div>
          </div>
          <p className="text-foreground/90 leading-relaxed">
            Questo evento è perfetto per te! Basandoci sui tuoi interessi passati
            per eventi culturali e musicali, crediamo che ti piacerà. Inoltre, è
            molto popolare tra gli studenti universitari e offre un'ottima
            opportunità per socializzare con persone che condividono i tuoi
            interessi.
          </p>
          ...
          {!canShare && (
            <div className="mb-4 p-4 bg-orange-500/10 border-2 border-orange-500/30 rounded-2xl">
              <p className="text-sm text-orange-600 font-medium text-center">
                ⚠️ Abilita "Condividi Attività" nelle Preferenze per partecipare agli eventi
              </p>
            </div>
          )}
